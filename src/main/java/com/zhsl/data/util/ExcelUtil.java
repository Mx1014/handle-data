...
public class ExcelUtil {
    ...
    public List<Row> readExcel_xlsx(FileInputStream is) throws IOException {
        XSSFWorkbook wb = null;
        List<Row> rowList = new ArrayList<Row>();
        try {
            // 去读Excel
    ...
    public static String getCellValueForCell(Cell cell) {
        Object result = "";
        if (cell != null) {
            switch (cell.getCellType()) {
                case Cell.CELL_TYPE_STRING:
    ...
    public static String getCellValueForCellNum(HSSFWorkbook wb, Cell cell) {
        Object result = "";
        DecimalFormat df = new DecimalFormat("0");
        result = df.format(cell.getNumericCellValue()*100);
        return result.toString();
    }
